...
export const PRESEEDED_USERS: AuthUser[] = [
  ...
  // 4. LEVEL 3: TEHSIL & PROJECT OFFICER LEVEL
  {
    ...
    jurisdiction: {
      ...
      tehsil: "Sinnar",
      projectId: "PRJ-001",
      projectName: "NH-48 Greenfield Express Bypass Corridor",
      displayText: "NH-48 Greenfield Express Corridor (PRJ-001)",
    },
  ...
  // 5. CITIZEN LEVEL
  {
    ...
    jurisdiction: {
      ...
      district: "Nashik",
      projectId: "PRJ-001",
      displayText: "Musalgaon, Gat No. 101 (Khasra 101)",
    },
    parentAuthorityId: "USR-PRJ-SIN",
    parentAuthorityTitle: "Executive Project Director, NHAI Nashik",
