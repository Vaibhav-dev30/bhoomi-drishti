...
> = {
  ...
  district_collector: {
    ...
    title: "District Magistrate & CALA",
    dept: "District Administration, North Delhi",
    jurisdiction: "North Delhi District",
  ...
  field_surveyor: {
    ...
    dept: "Tehsil Office, Alipur, North Delhi",
  ...
  public: {
    ...
    jurisdiction: "Alipur Locality, Survey DEMO-482",
    badge: "Citizen",
  },
};
